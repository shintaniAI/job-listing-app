...
【絶対ルール】
- **最優先**: 先頭の「=== SOURCE URL:」ソース（Talentio/HRMOS/Wantedly等の求人詳細ページ）を正本として情報を漏らさず全て転記する
...
- 求人媒体（Indeed/doda/マイナビ転職/リクナビNEXT/エン転職等）もソースに含まれていれば参照OK。ただし公式ページが優先、媒体は補完用途
